...
//		System.out.println("memberList.get(1).getTeam.getName()->"+memberList.get(1).getTeam().getName());			
	...
	public String memberModify(Long id, Model model) {
		...
		return "members/memberModifiy";
	}
	
	@GetMapping(value = "/members/memberUpdate")
	public String memberUpdate(Member member, Model model) {
		
		System.out.println("MemberControler memberUpdate id->"+member.getId());
		System.out.println("MemberControler memberUpdate member.getName->"+member.getName());
		System.out.println("MemberControler memberUpdate member.getTeamname->"+member.getTeamname());		
